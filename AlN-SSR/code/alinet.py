...
class AliNet:
    def __init__(self, adj, tadj, kg1, kg2, sup_ent1, sup_ent2, ref_ent1, ref_ent2, tri_num, ent_num, rel_num,
                 rel_ht_dict, args):
    ...
    def test(self, can_len, weight):
        ...
        for weight in range(0, 55, 5):
            weight /= 10
            get_accuracy_by_structure(embeds1, embeds2, self.ref_ent1, self.ref_ent2,
                                      5, self.adj, weight)
