...
parser.add_argument('--cand', type=int, default=5)
parser.add_argument('--weight', type=float, default=0.22)
...
if __name__ == '__main__':
    ...
    tadj = get_adj(ent_num, kg1.triple_list + kg2.triple_list)
    gcn_model = get_model(args.embedding_module)(adj, tadj, kg1, kg2, sup_ent1, sup_ent2, ref_ent1, ref_ent2,
    ...
    gcn_model.test(args.cand, args.weight)
