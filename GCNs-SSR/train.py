...
flags.DEFINE_integer('can_len', 5, 'Length of candidate sets.')
flags.DEFINE_float('weight', 0.5, 'Weight of neighbor information.')
...
get_accuracy_by_structure(vec_se, test, FLAGS.can_len, adj, FLAGS.weight)
# print("SE+AE")
